...
CREATE DATABASE IF NOT EXISTS yimo
...
CREATE TABLE IF NOT EXISTS `article` (
    ...
    INDEX `idx_is_top` (`is_top`, `status`),
    CONSTRAINT `fk_article_category` FOREIGN KEY (`category_id`) REFERENCES `article_category`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='生肖表';
...
CREATE TABLE IF NOT EXISTS `zodiac_story` (
    ...
    `content`     LONGTEXT     DEFAULT NULL              COMMENT '故事内容(HTML)',
    ...
    `update_time` DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (`id`),
    INDEX `idx_zodiac` (`zodiac_id`),
    CONSTRAINT `fk_story_zodiac` FOREIGN KEY (`zodiac_id`) REFERENCES `zodiac`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='生肖故事表';
...
CREATE TABLE IF NOT EXISTS `clay_sculpture` (
    ...
    INDEX `idx_zodiac` (`zodiac_id`),
    INDEX `idx_status_sort` (`status`, `sort_order`),
    CONSTRAINT `fk_sculpture_zodiac` FOREIGN KEY (`zodiac_id`) REFERENCES `zodiac`(`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='泥塑作品表';
...
CREATE TABLE IF NOT EXISTS `personality_question` (
    ...
    INDEX `idx_sort` (`sort_order`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='性格测试题目表';
...
CREATE TABLE IF NOT EXISTS `personality_option` (
    ...
    CONSTRAINT `fk_option_question` FOREIGN KEY (`question_id`) REFERENCES `personality_question`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='性格测试选项表';
...
CREATE TABLE IF NOT EXISTS `personality_result` (
    ...
    PRIMARY KEY (`id`),
    INDEX `idx_zodiac` (`zodiac_id`),
    CONSTRAINT `fk_result_zodiac` FOREIGN KEY (`zodiac_id`) REFERENCES `zodiac`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='性格测试结果表';
...
CREATE TABLE IF NOT EXISTS `test_record` (
    ...
    `dimension_score` JSON         DEFAULT NULL              COMMENT '维度得分(JSON)',
    ...
    CONSTRAINT `fk_record_zodiac` FOREIGN KEY (`zodiac_id`) REFERENCES `zodiac`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `product` (
    ...
    `detail`      LONGTEXT      DEFAULT NULL              COMMENT '产品详情(HTML)',
    `image_url`   VARCHAR(512)  NOT NULL                  COMMENT '产品主图URL',
    `images`      JSON          DEFAULT NULL              COMMENT '产品图片集(JSON数组)',
    ...
    INDEX `idx_category` (`category_id`),
    INDEX `idx_zodiac` (`zodiac_id`),
    INDEX `idx_hot_recommend` (`is_hot`, `is_recommend`, `status`),
...
CREATE TABLE IF NOT EXISTS `user_behavior` (
    ...
    INDEX `idx_create_time` (`create_time`),
    INDEX `idx_user_type_time` (`user_id`, `behavior_type`, `create_time`)
